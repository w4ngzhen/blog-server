...
export default async function (c: Context) {
  ...
  let envAllowedOrigins = c.env.ALLOWED_ORIGINS
  ...
  const allowedOrigins = [c.env.SITE_URL, ...envAllowedOrigins];
  ...
  const validHostnames = ['api.github.com', 'avatars.githubusercontent.com'];
  ...
  let useBodyList = ['POST', 'PUT', 'PATCH', 'DELETE'];
